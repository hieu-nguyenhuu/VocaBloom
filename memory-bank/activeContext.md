...
> Cập nhật lần cuối: **2026-09-19** (kết thúc M8 — Quản lý từ vựng; **app không còn màn stub nào**)
...
3. **🟡 Skill `vocab-csv-to-import` nằm ở `import_csv_vocab/`** (gốc repo), không ở `.claude/skills/`
